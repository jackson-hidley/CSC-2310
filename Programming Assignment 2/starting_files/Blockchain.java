...
public class Blockchain extends JFrame {
	...
	public Blockchain() {
		...
		String[] names = {" Jackson ", " John ", " Ash", " Ben", " James ", " Konnor "};
		...
		signBtn.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				String tran = Integer.toString( transactionNum ) + ". " + payerCombo.getSelectedItem().toString() + paidCombo.getSelectedItem().toString() + txtAmount.getText();
		...
		btnMineBlock.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Block block = new Block(blockNum, currentTree, prevBlock, difficulty);
